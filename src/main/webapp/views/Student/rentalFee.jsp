...
<%int i=0;%>
	<%@include file="headerStudent.jsp"%>
	   <form id="registerRoomForm" action="phithuephong" method="post">
	<div class="row">
		...
		<div id="sidebar" class="span12">
				...
				<div class="well well-small">
					<h4  align="center" style=" color: green; font-size:22px; ">Phí thuê phòng</h4>
					<hr class="soften" />
					<div class="well well-small"
						style="min-height: 70px; background: #ffffff; margin-bottom: 8px">
								...
								<div class="row">
									...
									<div class="span3"><b>${ student.tenSV }</b></div>
									<div class="span2"><p>Mã số: </p></div>
									<div class="span2"><b>${student.maSV }</b></div>
								</div>
								<div class="row">
									<div class="span1-5"></div> 
									<div class="span2"><p>Học kỳ: </p></div>
									<div class="span3"><b>Kỳ 1 - Năm học 2021-2022 </b></div>
									<div class="span2"><p>Phí thuê/Tháng: </p></div>
									<div class="span2"><b>${phimoithang }</b></div>
								</div>
								<div class="row">
									<div class="span1-5"></div> 
									<div class="span2"><p>Số tháng: </p></div>
									<div class="span3"><b>5</b></div>
									<div class="span2"><p>Tổng phí cần nộp: </p></div>
									<div class="span2"><b>${tongphi }</b></div>
								</div>
								<div class="row">
									<div class="span1-5"></div> 
									<div class="span2"><p>Thời hạn thanh toán: </p></div>
									<div class="span3"><b>${fee.thoiHan }</b></div>
									<div class="span2"><p>Trạng thái: </p></div>
									<c:choose>
									<c:when test="${fee.trangThai }">
									<div class="span2"><b>Đã thanh toán</b></div>
									</c:when>
									<c:otherwise>
									<div class="span2"><b>Chưa thanh toán</b></div>
									</c:otherwise>
									</c:choose>
								...
								<div class="row">
									<div class="span1-5"></div> 
									<div class="span2"><p>Hình thức thanh toán: </p></div>
...
/*  document.getElementById("p").innerHTML = document.getElementById("phong").value.trim(); */
