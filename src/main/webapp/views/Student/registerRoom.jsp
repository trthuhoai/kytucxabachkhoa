	...
	<div class="row">
		...
		<div id="sidebar" class="span12">
				...
				<div class="well well-small">
					<h4  align="center" style=" color: green; font-size:22px; ">Đăng ký phòng</h4>
					<hr class="soften" />
					<div class="well well-small"
						...
						<table align="center">
							...
							<tr>
								<td><p > Học kỳ:</p> </td>
								<td><p > Kỳ 1 - Năm học 2021-2022</p> </td>
							</tr>
							<c:choose>
							 <c:when test="${empty khu}">
							 	<tr>
								<td> Chọn khu: </td>
								<td>  		<select id="khu" name="khu" >
							...
							<tr>
								<td> Nhập số phòng: </td>
								<td>  <input type="text" id="phong" name="phong" >  </td>
							</tr>
							</c:when> 
							<c:otherwise>
								<tr>	
							...
							<tr>
								<td> Nhập số phòng: </td>
								<td>  <input type="text" id="phong" name="phong" value="${ phong }">  </td>
							</tr>
							</c:otherwise>
							</c:choose>
						</table> 		
			...
			<div id="id" class="well well-small" style="min-height: 70px; background: #ffffff; ">
			<h5   style=" color: green; font-size:20px; ">Thông tin các phòng:</h5>
			<hr class="soften" />
		 	<form id="searchRoomForm" action="timkiem" method="post">
			<div class="row">
		...
		<tr style="background-color:blue; color: #ffffff; font-weight:bold; ">
			...
			<td style="background-color:#724585">Đã đăng ký</td>
...
<!-- 	<input type="button" value="press" id="press" class="clo"> -->
 ...
 <div class="popUpBannerInner">
  <div class="popUpBannerContent">
   <p><a href="#" class="closeButton">Close</a></p>
	   <form id="registerRoomForm" action="dangkyphong" method="post">
						...
						<div class="well well-small" style="border-radius:0px; background: #ffffff;">
						 <input type="hidden" id="phong1" name="phong" >
						  <input type="hidden" id="khu1" name="khu" >
							<h5 style=" color: #643544; font-weight: 10px">Bạn có chắc chắn muốn đăng ký Phòng <span id="p"></span> Nhà <span id="k"></span> không? </h5>
						</div>
