...
    		<a href="<%=request.getContextPath() %>/admin/CheckThongKe">Thống kê</a>
			<a class="active" href="<%=request.getContextPath() %>/admin/doi-mat-khau">Đổi mật khẩu</a>
				...
				<div style = "margin-left: 40px">
					<div>
						<div class="container-chat">
						    <h4>Đổi mật khẩu tài khoản cá nhân</h4>
						    <form action="<%=request.getContextPath() %>/admin/doi-mat-khau" method="post">
						    	<span style="font-style: italic; color: red; font-size: 13px">${oldPasswordError}</span>
						        <input type="password" id="oldPassword" name="oldPassword" placeholder="Nhập mật khẩu cũ">
						        
						        <span style="font-style: italic; color: red; font-size: 13px">${passwordError}</span>
						        <input type="password" id="password" name="password" placeholder="Nhập mật khẩu mới">
						        
						        <span style="font-style: italic; color: red; font-size: 13px">${confirmPasswordError}</span>
