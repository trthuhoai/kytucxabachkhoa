...
<head>
	<meta charset="utf-8">
	<title>Admin | Thêm mới nhân viên</title>
				...
				<div style = "margin-left: 40px">
					<div>
						<div class="container-chat">
						    ...
						    <form action="<%=request.getContextPath() %>/admin/nhan-vien/them-moi" method="post">
						    	<%
						    	...
						    	<span style="font-style: italic; color: red; font-size: 13px">${maNVError}</span>
						        <input type="text" id="manv" name="manv" value="${nv.maNV}" placeholder="Nhập mã nhân viên (tài khoản)">
