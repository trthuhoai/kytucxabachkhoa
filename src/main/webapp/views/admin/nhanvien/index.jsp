		...
		<div class="content">
			<div>
				...
				<div class="content-box-large" style="margin: 20px 100px">
					<div class="row">
						<div class="col-md-6">
							<a href="<%=request.getContextPath() %>/admin/nhan-vien/them-moi" class="btn btn-success">Thêm mới</a>
						</div>
	                	<div class="col-md-6">
		                	<form action="<%=request.getContextPath() %>/admin/nhan-vien" method="get">
			                 	 <div class="input-group form">
			                       ...
			                       <select id="thuoctinh" name="thuoctinh" style="height: 34px">
			                       		...
			                       		<option value="chucvu" <% if (thuocTinh.equals("chucvu")) out.print("selected"); %>>Theo chức vụ</option>
			                       </select>
					...
					<div class="row">
		  				<div class="panel-body">
		  					...
		  					<%
								...
								if (request.getAttribute("totalPage") != null) {
		  						...
		  						if (request.getAttribute("listNV") != null) {
		  							List<NhanVien> listNV = (ArrayList<NhanVien>) request.getAttribute("listNV");
		  							if (listNV.size() > 0) {
		  					%>
		  					<table class="table table-striped table-bordered" id="example">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td class="center"><%=nv.getChucVu() %></td>
										<td style="text-align: center">
											<a href="<%=request.getContextPath() %>/admin/nhan-vien/xem-chi-tiet?manv=<%=nv.getMaNV() %>" title="" class="btn btn-primary">Xem chi tiết</a>
										</td>
									</tr>
									<%
										}
							...
							<nav class="text-center" aria-label="...">
							   <ul class="pagination">
							   	  <%
							   			String url = request.getContextPath() + "/admin/nhan-vien?";
